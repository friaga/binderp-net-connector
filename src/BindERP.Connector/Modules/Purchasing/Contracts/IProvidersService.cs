...
public interface IProvidersService
{
    ...
    Task<Page<Provider>?> GetProvidersPageAsync(SearchCriteria? criteria = null, CancellationToken cancellationToken = default);

    //Task<Guid?> CreateProviderAsync(object provider, CancellationToken cancellationToken = default);

    //Task<bool?> EditProviderAsync(object provider, CancellationToken cancellationToken = default);

    //Task<bool?> DeleteProviderAsync(GUid identifier, CancellationToken cancellationToken = default);
}
