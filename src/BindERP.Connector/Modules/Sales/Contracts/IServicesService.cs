...
public interface IServicesService
{
    ...
    Task<Page<ServiceRecord>?> GetServicesPageAsync(SearchCriteria? criteria = null, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="HttpRequestException">Lanzada cuando ha ocurrido un error en el envio de la operación.</exception>
    /// <exception cref="TaskCanceledException">Lanzada cuando la operación es cancelada.</exception>
    Task<Service?> GetServiceAsync(Guid serviceID, CancellationToken cancellationToken = default);



    //Task<Guid?> CreateServiceAsync(object service, CancellationToken cancellationToken = default);

    //Task<bool> EditServiceAsync(object service, CancellationToken cancellationToken = default);
