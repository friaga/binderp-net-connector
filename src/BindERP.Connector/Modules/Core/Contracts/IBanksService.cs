...
/// <summary>
/// Representa la interfase del servicio de bancos.
/// </summary>
public interface IBanksService
{
    ...
    Task<Page<Bank>?> GetBanksPageAsync(SearchCriteria? criteria = null, CancellationToken cancellationToken = default);
}
